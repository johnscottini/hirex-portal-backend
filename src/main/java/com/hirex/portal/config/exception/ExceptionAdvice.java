package com.hirex.portal.config.exception;

import com.hirex.portal.config.lib.commom.Messages;
import com.hirex.portal.exception.BusinessException;
import com.hirex.portal.exception.EntityNotFoundException;
...
public class ExceptionAdvice {
    ...
    public @ResponseBody
    Map<String, String> authentication(BadCredentialsException e) {
    ...
    public @ResponseBody
    Map<String, String> authentication(AccessDeniedException e) {
        Map<String, String> msg = new HashMap<>();
        msg.put(MESSAGES_PARAM, e.getMessage());
        return msg;
    }
    ...
    public @ResponseBody Map<String, Object> unexpectedErrorHandler(Exception e, HttpServletRequest req) {
